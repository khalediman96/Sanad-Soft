...
const translations = {
  en: {
    ...
    pricing: {
      ...
      description: 'Clear and scalable packages designed for startups, growing businesses, and large institutions that need secure digital payment infrastructure.',
      plans: [
        {
          name: 'Starter',
          badge: 'Launch',
          ...
          description: 'A practical foundation for startups and small businesses beginning their digital payments journey.',
          features: ['Payment acceptance setup', 'Basic dashboard', 'Secure onboarding', 'Email support'],
          cta: 'Request Starter',
        },
        {
          name: 'Growth',
          ...
          description: 'Advanced capabilities for businesses ready to expand with more integrations, insights, and transaction volume.',
          features: ['Advanced analytics', 'API integrations', 'Priority support', 'Multi-channel payments'],
          cta: 'Choose Growth',
        },
        {
          name: 'Enterprise',
          ...
          description: 'A premium package for banks, telecoms, and large organizations that need custom infrastructure and dedicated support.',
          features: ['Custom integrations', 'Dedicated account manager', 'Compliance workflows', '24/7 technical support'],
          cta: 'Talk to Sales',
        },
      ],
      note: 'All plans include secure deployment, onboarding guidance, and infrastructure built for reliability, compliance, and long-term growth.',
    },
    solutions: {
  ...
  ar: {
    ...
    pricing: {
      ...
      title: 'خطط مرنة',
      titleHighlight: 'لكل مرحلة نمو',
      description: 'باقات واضحة وقابلة للتوسع مصممة للشركات الناشئة، والأعمال المتنامية، والمؤسسات الكبيرة التي تحتاج إلى بنية دفع رقمية آمنة.',
      plans: [
        {
          name: 'البداية',
          badge: 'انطلاق',
          price: 'مخصص',
          period: 'للفرق الصغيرة',
          description: 'أساس عملي للشركات الناشئة والأعمال الصغيرة التي تبدأ رحلتها في المدفوعات الرقمية.',
          features: ['إعداد قبول المدفوعات', 'لوحة تحكم أساسية', 'تهيئة آمنة', 'دعم عبر البريد الإلكتروني'],
          cta: 'اطلب الباقة',
        },
        {
          name: 'النمو',
          ...
          description: 'إمكانات متقدمة للشركات الجاهزة للتوسع مع تكاملات أكثر ورؤى أوضح وحجم معاملات أعلى.',
          features: ['تحليلات متقدمة', 'تكاملات API', 'دعم أولوية', 'مدفوعات متعددة القنوات'],
          cta: 'اختر النمو',
        },
        {
          name: 'المؤسسات',
          badge: 'مخصص',
          price: 'مؤسسي',
          period: 'للمؤسسات الكبرى',
          description: 'باقة متميزة للبنوك وشركات الاتصالات والجهات الكبيرة التي تحتاج إلى بنية تحتية مخصصة ودعم متفانٍ.',
          features: ['تكاملات مخصصة', 'مدير حساب خاص', 'مسارات امتثال', 'دعم فني 24/7'],
          cta: 'تواصل مع المبيعات',
        },
      ],
      note: 'تشمل جميع الباقات إعداداً آمناً، وإرشاداً أثناء الإطلاق، وبنية تحتية مصممة للموثوقية والامتثال والنمو طويل الأمد.',
    },
    solutions: {
      ...
      items: [
        ...
        },
        {
          ...
          benefits: ['معالجة مطالبات التأمين', 'فوترة المرضى', 'نقاط بيع الصيدليات', 'الامتثال للمعايير'],
        },
        {
          industry: 'الحكومة',
